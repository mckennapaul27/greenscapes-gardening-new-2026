...
export const metadata: Metadata = {
  title: "Artificial Grass Supply & Fit | Premium Artificial Lawn Installation",
  description:
    "Professional artificial grass supply and installation services in Cheshire & South Manchester. Premium artificial lawn installation for low-maintenance, year-round green lawns.",
  keywords: [
    "artificial grass",
    "artificial lawn",
    "fake grass",
    ...
    "artificial grass Stockport",
  ],
  openGraph: {
    title:
      "Artificial Grass Supply & Fit | Premium Artificial Lawn Installation",
    description:
      "Professional artificial grass supply and installation. Premium low-maintenance lawns.",
    type: "website",
  },
};
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <CustomerFeedbackWrapper
        bgColor={hasGallery ? "bg-white" : "bg-[#f9f9f9]"}
      />
      <CTA
