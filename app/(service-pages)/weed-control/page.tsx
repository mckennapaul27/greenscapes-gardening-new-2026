...
export const metadata: Metadata = {
  title: "Weed Control Services | Professional Weed Removal | Greenscapes",
  description:
    "Professional weed control and removal services in Cheshire & South Manchester. Effective weed elimination while protecting your plants. Regular maintenance and one-off treatments available.",
  keywords: [
    "weed control",
    "weed removal",
    "weed elimination",
    ...
    "weed removal Cheshire",
    "professional weed control",
  ],
  openGraph: {
    title: "Weed Control Services | Professional Weed Removal | Greenscapes",
    description:
      "Professional weed control services. Effective weed elimination while protecting your plants.",
    type: "website",
  },
};
...
export default function WeedControlPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      />
      {hasGallery && (
        <Gallery images={galleryImages} title="Our Weed Control Service" />
      )}
