...
export const metadata: Metadata = {
  title: "Garden Maintenance Services | Greenscapes Gardening",
  description:
    "Professional garden maintenance services in Cheshire & South Manchester. Regular garden care including lawn mowing, weeding, pruning, and seasonal maintenance. Expert gardeners serving Stockport, Bramhall, Poynton, and surrounding areas.",
  keywords: [
    "garden maintenance",
    "garden care",
    "lawn mowing",
    ...
    "garden maintenance Cheshire",
    "garden maintenance Stockport",
  ],
  openGraph: {
    title: "Garden Maintenance Services | Greenscapes Gardening",
    description:
      "Professional garden maintenance services to keep your outdoor space beautiful and healthy year-round.",
    type: "website",
  },
};
