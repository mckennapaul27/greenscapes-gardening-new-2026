...
export const metadata: Metadata = {
  title: "Garden Waste Removal Services | Greenscapes Gardening",
  description:
    "Professional garden waste removal services in Cheshire & South Manchester. Efficient garden debris and waste clearance. Registered waste carriers with responsible disposal.",
  keywords: [
    ...
    "waste removal Cheshire",
  ],
  openGraph: {
    title: "Garden Waste Removal Services | Greenscapes Gardening",
    description:
      "Professional garden waste removal and clearance services. Responsible disposal of garden debris.",
    type: "website",
  },
};
